...
t1=Thread(target=(create),args=('a',2,1 )) #as per the operation


t2=Thread(target=(read),args=('a')) #as per the operation


t3=Thread(target=(delete),args=('a')) #as per the operation
...
with open("sample.json", "w") as outfile:  
    json.dump(d, outfile)
# 'json.dump(d, outfile)' create a json file where the program is loacated in local drive
